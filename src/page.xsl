    ...
    <xsl:template match="page:page">
        <html lang="en">
            ...
            <head>
                ...
                <xsl:text>&#10;      </xsl:text>
                <link rel="stylesheet" href="/css/main.css"/><script src="/js/oat.min.js" defer="defer"></script><link rel="author" href="/humans.txt"/><link rel="me" href="https://micro.blog/benad"/>
                <xsl:text>&#10;      </xsl:text>
