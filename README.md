...
* `_includes`: Shared 11ty templates.
* `_site`: Web site, once generated by 11ty.
* `eleventy.config.js`: 11ty config.
* `content`: Input content files for 11ty.
* `generated`: Additional generated files needed as input for 11ty.
* `public`: Additional static files to add to the files generated by 11ty.
* `scripts`: Scripts used to generate or tweak the content files.
* `src`: Additional input files for 11th.
